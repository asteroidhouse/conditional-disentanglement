...
for metric_to_plot in ['avg_loss', 'avg_acc', 'f1_acc', 'f2_acc']:
  ...
  plt.savefig(os.path.join(figure_dirname, '{}_corr.png'.format(metric_to_plot)), bbox_inches='tight', pad_inches=0)
  plt.savefig(os.path.join(figure_dirname, '{}_corr.pdf'.format(metric_to_plot)), bbox_inches='tight', pad_inches=0)
  plt.close(fig)
