# This file is from: https://github.com/OctoberChang/MMD-GAN
import ipdb
import torch
min_var_est = 1e-8
...
# sigma for MMD
base = 1.0
SIGMAS = [1./16,1./8,1./4,1./2,1, 2, 4, 8, 16]
SIGMAS = [sigma / base for sigma in SIGMAS]
...
def multi_scale_rbf_kernel(Z, sigma_list):
    ZZT = torch.mm(Z, Z.t())
...
def mix_rbf_kernel(X, Y, sigma_list):
    ...
    Z = torch.cat((X, Y), 0)
    K = multi_scale_rbf_kernel(Z, sigma_list)
